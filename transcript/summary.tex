...
\begin{document}
  ...
  \begin{center}
    \begin{tikzcd}[column sep=1.5in]
      A^{m^\prime} \times B^{n^\prime} \times \mathcal T(m + n) \arrow[r, "{\id{A^{m^\prime} \times B^{n^\prime}} \times \mathcal T(f + g)}"] \arrow[d, "{A^f \times B^g \times \id{\mathcal T(n + m)}}"] & A^{m^\prime} \times B^{n^\prime} \times \mathcal T(m^\prime + n^\prime) \arrow[d, "{e_{m^\prime, n^\prime}}"]\\
      A^m \times B^n \times \mathcal T(m + n) \arrow[r, "{e_{m, n}}"] & C,\\
    \end{tikzcd}
  \end{center}
  ...
  \begin{center}
    \begin{tikzcd}
      A^{m^\prime} \times B^{n^\prime} \times \mathcal T(m + n) \arrow[r] \arrow[d] & A^{m^\prime} \times B^{n^\prime} \times \mathcal T(m^\prime + n^\prime) \arrow[d] \arrow[rdd, "{e^\prime_{m^\prime, n^\prime}}", bend left] & \\
      A^m \times B^n \times \mathcal T(m + n) \arrow[r] \arrow[rrd, "{e^\prime_{m, n}}", bend right] & C \arrow[rd, "\exists! F", dashed] & \\
      & & C^\prime
    \end{tikzcd}
  \end{center}
  ...
  \begin{center}
    \begin{tikzcd}[column sep=1.3in]
      \left( A^l \right)^{m^\prime} \times \left( B^l \right)^{n^\prime} \times \mathcal T(m + n)^l
        \arrow[r, "{\id{\left( A^l \right)^{m^\prime} \times \left( B^l \right)^{n^\prime}} \times \mathcal T(f + g)^l}"]
        \arrow[d, "{\left( A^l \right)^f \times \left( B^l \right)^g \times \id{\mathcal T(n + m)^l}}"]
      & \left( A^l \right)^{m^\prime} \times \left( B^l \right)^{n^\prime} \times \mathcal T(m^\prime + n^\prime)^l
        \arrow[d, "{e^{\prime \prime}_{m^\prime, n^\prime}}"]
      \\ \left( A^l \right)^m \times \left( B^l \right)^n \times \mathcal T(m + n)^l
        \arrow[r, "{e^{\prime \prime}_{m, n}}"]
      & A^m \times B^n \times \mathcal T(m + n) \arrow[d, "{e_{m, n}}"]
      \\
      & C\\
    \end{tikzcd}
  \end{center}
