...
\begin{definition}\label{def:Yoneda-embedding}
  The \iindex{Yoneda embedding} $ \yo : C \hookrightarrow P C $ is given on objects by $ \yo(c) = C(-, c) $:
...
\begin{proof}
  ...
  sending $ f : C(X, A \times B) $ to the pair $ (f \cdot \pi_1, f \cdot \pi_2) $ and conversely, sending a pair $ (g_1, g_2) : C(X, A) \times C(X, B) $ to the product morphism $ \langle g_1, g_2 \rangle : \yo(X, A \times B) $. This idea is also the core of the proof about general limits.
\end{proof}
...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzcd}
      \yo(c)(d) \arrow[d, "g \cdot -"] \arrow[r, "f_{d, c}"] & \op f_*(\yo(f(c)))(d) \arrow[d, "f_{d^\prime, d}(g) \cdot -"]\\
      \yo(c)(d^\prime) \arrow[r, "f_{d^\prime, c}"] & \op f_*(\yo(f(c)))(d^\prime)
    \end{tikzcd}
  \end{center}
  ...
  \begin{center}
    \begin{tikzcd}
      \yo(c)(d) \arrow[d, "- \cdot g"] \arrow[r, "f_{d, c}"] & \op f_*(\yo(f(c)))(d) \arrow[d, "- \cdot f_{c, c^\prime}(g)"]\\
      \yo(c^\prime)(d) \arrow[r, "f_{d, c^\prime}"] & \op f_*(\yo(f(c^\prime)))(d)
    \end{tikzcd}
  \end{center}
