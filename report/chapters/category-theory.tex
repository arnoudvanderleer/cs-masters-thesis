...
\section{Yoneda}
We can embed a category $ C $ fully faithfully into the functor category $ P C = [\op C, \SET] $ as follows (see \cite{Kashiwara}, Section 1.4):
\begin{definition}
...
\end{lemma}
\begin{proof}
  See \cite{Kashiwara}, Proposition 1.4.3.
\end{proof}
...
\end{lemma}
\begin{proof}
  See \cite{borceux}, Volume 1, Proposition 2.15.5.
\end{proof}

\begin{lemma}
  The Yoneda embedding functor preserves exponential objects (\cite{stackexchange:yoneda-exponentials}).
\end{lemma}
\begin{proof}
...
\end{lemma}
\begin{proof}
  See \cite{borceux}, Volume 3, Lemma 5.8.2. This lemma shows this via the following equivalences:
  \begin{align*}
