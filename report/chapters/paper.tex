...
\begin{proof}
  ...
  % We need to show that this is natural in $ X $. Therefore, take $ g : \R_A(X, Y) $. Then $ \R_B(\mathbf 1_1, F(g)) $ is given by postcomposition with $ F(g) $. Also, $ F^*(\R_A(\mathbf 1_1, g)) $ is given by postcomposing with $ g $ on the component $ \R_A(\mathbf 1_1, g) $. Then
