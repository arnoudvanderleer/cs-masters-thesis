...
Write $ i: \op{L_1} \hookrightarrow \op{\mathbf L} $ and $ j: \op{\mathbf L} \hookrightarrow \op \R $ for the embeddings on the opposite categories. By Corollary \ref{cor:surjective-precomposition}, the first three categories in this sequence yield the following sequence of essentially surjective functors on the presheaf categories:
\begin{center}
  \begin{tikzcd}
    & \Pshf L \arrow[d, "\sim"]\\
