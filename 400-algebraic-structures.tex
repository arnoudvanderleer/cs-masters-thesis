...
\begin{remark}[\coqident{AlgebraicTheories.AlgebraicTheoryCategory}{limits_algebraic_theory_cat}]\label{rem:algebraic-theory-limits}
...
\begin{remark}[\coqident{AlgebraicTheories.AlgebraicTheoryCategory}{is_univalent_algebraic_theory_cat}]
...
\begin{remark}[\coqident{AlgebraicTheories.AlgebraCategory}{is_univalent_algebra_cat}]
...
\begin{remark}[\coqident{AlgebraicTheories.PresheafCategory}{limits_presheaf_cat}]
...
\begin{definition}[\coqident{AlgebraicTheories.LambdaTheories}{has_β}]
...
\begin{remark}[\coqident{AlgebraicTheories.LambdaTheoryCategory}{limits_lambda_theory_cat}]
...
\begin{remark}[\coqident{AlgebraicTheories.LambdaTheoryCategory}{is_univalent_lambda_theory_cat}]
...
\begin{remark}[\coqident{AlgebraicTheories.LambdaTheories}{beta_equality}]
...
\begin{remark}[\coqident{AlgebraicTheories.Examples.TheoryAlgebra}{theory_algebra_free}]
...
\begin{remark}[\coqident{AlgebraicTheories.RepresentationTheorem}{presheaf_to_L}]\label{rem:presheaf-Yoneda}
