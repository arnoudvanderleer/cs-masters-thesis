...
% IndexedSetCategory.v
  \item The univalent category $ \SET^A $ of indexed sets $ (X_a)_a $ over a type $ A $ (\coqident{AlgebraicTheories.IndexedSetCategory}{is_univalent_indexed_set_cat}, \coqident{AlgebraicTheories.IndexedSetCategory}{limits_indexed_set_cat}), which can be defined formally as
